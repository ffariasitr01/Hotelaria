 ...
 * @author paulo
 */
public class IFrmSolicitacaoMercadorias extends javax.swing.JInternalFrame {

    /**
     * Creates new form IFrmSolicitacaoMercadorias
     */
    public IFrmSolicitacaoMercadorias() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Solicitação de Mercadorias");
